...
// Molécula: ciclopentano
const molecule = {
  name: 'Ciclopentano',
  formula: 'C5H10'
}

// Carbonos do anel (aproximadamente pentágono)
const atoms = [
  { id: 'C1', element: 'C', x: 200, y: 80, tooltipTitle: 'C1 — Ciclopentano', info: { classificacao: 'Carbono Secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C2', element: 'C', x: 300, y: 140, tooltipTitle: 'C2 — Ciclopentano', info: { classificacao: 'Carbono Secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C3', element: 'C', x: 250, y: 260, tooltipTitle: 'C3 — Ciclopentano', info: { classificacao: 'Carbono Secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C4', element: 'C', x: 150, y: 260, tooltipTitle: 'C4 — Ciclopentano', info: { classificacao: 'Carbono Secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C5', element: 'C', x: 100, y: 140, tooltipTitle: 'C5 — Ciclopentano', info: { classificacao: 'Carbono do anel', hibridacao: 'sp3', nota: '' } }
]
...
const ringBonds = [
  ...
  { x1: atoms[4].x, y1: atoms[4].y, x2: atoms[0].x, y2: atoms[0].y }
]

// Hidrogênios (2 por carbono)
const hydrogens = [
  { parent: atoms[0], x: 180, y: 50 }, { parent: atoms[0], x: 220, y: 50 },
  { parent: atoms[1], x: 330, y: 120 }, { parent: atoms[1], x: 330, y: 160 },
  { parent: atoms[2], x: 270, y: 290 }, { parent: atoms[2], x: 230, y: 290 },
  { parent: atoms[3], x: 130, y: 290 }, { parent: atoms[3], x: 170, y: 290 },
  { parent: atoms[4], x: 70, y: 120 }, { parent: atoms[4], x: 70, y: 160 }
]
