...
const atoms = [
  ...
  { id: 'C3', element: 'C', x: 122, y: 245, tooltipTitle: 'C3 — Ciclohexano', info: { classificacao: 'Carbono secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C4', element: 'C', x: 122, y: 155, tooltipTitle: 'C4 — Ciclohexano', info: { classificacao: 'Carbono secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C5', element: 'C', x: 278, y: 245, tooltipTitle: 'C5 — Ciclohexano', info: { classificacao: 'Carbono secundário', hibridacao: 'sp3', nota: '' } },
  { id: 'C6', element: 'C', x: 200, y: 290      , tooltipTitle: 'C6 — Ciclohexano', info: { classificacao: 'Carbono secundário', hibridacao: 'sp3', nota: '' } }
]
